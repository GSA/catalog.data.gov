describe('Spatial', () => {
    ...
    it('Can parse a harvest source with spacial tags in a list', () => {
        cy.request('/api/action/package_show?id=conformsto-iso-example-tiger-line-shapefile-2013-nation-u-s-current-county-and-equivalent-').should((response) => {
            ...
            expect(spatail_info).to.have.property('spatial', '{\"type\": \"Polygon\", \"coordinates\": [[[-14.601813, -179.231086], [-14.601813, 179.859681], [71.441059, 179.859681], [71.441059, -179.231086], [-14.601813, -179.231086]]]}');
        })
    });
});
