...
Create the SOLR service for data search
    $ cf create-service solr-cloud base ${app_name}-solr -c '{"solrImageRepo": "ghcr.io/gsa/catalog.data.gov.solr", "solrImageTag": "latest"}' -b ssb-solr-gsa-datagov-development
