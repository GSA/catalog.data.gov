...
def process_line(data):
    ...
    ok = True
    if data['request_path'].startswith('/fanstatic'): ok = False
    elif data['request_path'].startswith('/saml2'): ok = False
    elif data['request_path'].startswith('/css/'): ok = False
    elif data['request_path'].startswith('/base/'): ok = False
